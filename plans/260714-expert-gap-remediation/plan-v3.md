...
| SEC.1 | IDOR write-fence | B-SEC | T1 | M | code | — | — | ✅ | ☐ **SHIP-NOW** |
...
| 1.3a | wire completeness CI | B6 | T2 | S | — | — | — | — | ☐ **SHIP-NOW** |
| 1.3b | seed-vs-constant value-guard | B6 | T2 | L | — | — | — | — | ☐ (sau 1.4+1.1) |
| 1.4-U1 | delete stale MMR test + comment | now | T1 | S | — | — | — | — | ☐ **SHIP-NOW** |
| 1.4-U2 | MMR collapse | §8 | T1 | S | DB | ✅ | — | ✅ | ☐ DEFER (A/B) |
| 0.5 | degeneration tokenizer | now | T2 | S | CONST | — | — | ✅ | ☐ **SHIP-NOW** |
| 3.5 | cache-guard content-hash | now | T2 | M | — | — | — | ✅ | ☐ **SHIP-NOW** |
| 3.6 | dense-query NFC (+prewarm mirror) | now | T1 | S | — | — | — | ✅ | ☐ **SHIP-NOW** |
