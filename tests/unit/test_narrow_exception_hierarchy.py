...
_BROAD_EXCEPT_TOTAL_BASELINE = 251  # +2: 2026-07 guard-path hardening (empty-answer guard, claim/numeric-fidelity observe gates) — all noqa-annotated top-level handlers; no_noqa hard-rule stays 0
