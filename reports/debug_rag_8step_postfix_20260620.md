...
## STEP 1+2 — PARSE + CHUNK (structure)
  chinh-sach-xe                chunks=1954 table=1629 struct_path=0 children=1531 parents=262 avg_chars=445
  test-spa-id                  chunks=222 table=105 struct_path=0 children=131 parents=59 avg_chars=292
...
## STEP 3 — EMBED (leaf coverage)
  chinh-sach-xe                embedded=1692 null_leaf_BAD=8
  test-spa-id                  embedded=163 null_leaf_BAD=8
  thong-tu-09-2020-tt-nhnn     embedded=475 null_leaf_BAD=0
  → ❌ FAIL (null_leaf must be 0 — a leaf with no vector is invisible; parents NULL is by-design small-to-big)

## STEP 4 — STORE (searchable surfaces)
  chinh-sach-xe                tsvector=1954/1954 stats_index=2875
  test-spa-id                  tsvector=222/222 stats_index=384
...
## STEP 5-8 — RETRIEVE / GENERATE / GUARD / SCORE (live)
  ...
  test-spa-id                  COVERAGE=0.60 CHUNK_RECALL=0.20 HALLU=0.00 retr_miss=0 llm_miss=0
  thong-tu-09-2020-tt-nhnn     COVERAGE=1.00 CHUNK_RECALL=0.60 HALLU=0.00 retr_miss=0 llm_miss=0
  → STEP 5 RETRIEVE ⚠️  WARN · STEP 6 GENERATE ✅ PASS (COVERAGE mean 0.82) · STEP 7 GUARD ✅ PASS (HALLU max 0.00) · STEP 8 SCORE ✅ PASS

## OVERALL
  ❌ FAIL — 7 steps checked · 1 FAIL · 2 WARN