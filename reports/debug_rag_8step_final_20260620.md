...
## STEP 1+2 — PARSE + CHUNK (structure)
  chinh-sach-xe                chunks=1969 table=1779 struct_path=0 children=1706 parents=263 avg_chars=378
  test-spa-id                  chunks=222 table=106 struct_path=0 children=163 parents=59 avg_chars=296
...
## STEP 3 — EMBED (leaf coverage)
  chinh-sach-xe                embedded=1706 null_leaf_BAD=0
...
## STEP 4 — STORE (searchable surfaces)
  chinh-sach-xe                tsvector=1969/1969 stats_index=2112
  test-spa-id                  tsvector=222/222 stats_index=353
...
## STEP 5-8 — RETRIEVE / GENERATE / GUARD / SCORE (live)
  ...
  test-spa-id                  COVERAGE=1.00 CHUNK_RECALL=0.20 HALLU=0.00 retr_miss=0 llm_miss=0
  thong-tu-09-2020-tt-nhnn     COVERAGE=1.00 CHUNK_RECALL=0.60 HALLU=0.00 retr_miss=0 llm_miss=0
  → STEP 5 RETRIEVE ⚠️  WARN · STEP 6 GENERATE ✅ PASS (COVERAGE mean 0.95) · STEP 7 GUARD ✅ PASS (HALLU max 0.00) · STEP 8 SCORE ✅ PASS
