...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| chinh-sach-xe | 25 | 25 | 0.52 | 0.12 | 0.00 | 10 | 2 | 0 | 3787 | 0.0357 |
| **MEAN** |  |  | **0.52** | **0.12** |  |  |  |  |  |
...
- **chinh-sach-xe/g010** (gen_price_factoid) → `RETRIEVAL_MISS` · expect=`2358516` · chunks_used=1 · top_score=1.0 · retrieved_chars=2503
...
- **chinh-sach-xe/g018** (gen_price_factoid) → `RETRIEVAL_MISS` · expect=`2357515` · chunks_used=1 · top_score=1.0 · retrieved_chars=5705
- **chinh-sach-xe/g021** (gen_price_factoid) → `RETRIEVAL_MISS` · expect=`19000` · chunks_used=1 · top_score=1.0 · retrieved_chars=35042
- **chinh-sach-xe/g022** (gen_price_factoid) → `RETRIEVAL_MISS` · expect=`2520000` · chunks_used=1 · top_score=1.0 · retrieved_chars=408
- **chinh-sach-xe/g023** (gen_price_factoid) → `RETRIEVAL_MISS` · expect=`2857017` · chunks_used=1 · top_score=1.0 · retrieved_chars=3595
- **chinh-sach-xe/g024** (gen_price_factoid) → `LLM_MISS` · expect=`2856518` · chunks_used=1 · top_score=1.0 · retrieved_chars=10198
